...
namespace webapi.Controllers.API.Data.BikeShop
{
    ...
    /// derived from the name server-side. Behaviour-bearing statuses (estimate/ready/done/cancelled)
    ...
    /// <summary>Update a status's presentation (built-in or custom). Code and behaviour never change.</summary>
