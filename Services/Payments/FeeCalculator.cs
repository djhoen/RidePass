...
namespace Services.Payments
{
    ...
    public interface IFeeCalculator
    {
        ...
        /// </summary>
        Task<FeeCalculation> Calculate(Guid tenantId, int grossCents, int stripeFeeCents, int serviceChargeCents, DateTime occurredAtUtc);
    }
    ...
    public class FeeCalculator : IFeeCalculator
    {
        ...
        public async Task<FeeCalculation> Calculate(Guid tenantId, int grossCents, int stripeFeeCents, int serviceChargeCents, DateTime occurredAtUtc)
        {
