namespace Services.Repositories.Data.BikeShopData
{
    ...
    /// inventory and notifications. Built-ins (the seven canonical codes) can be renamed, recolored,
    /// reordered and flagged for notification, but their code and behavior are fixed. Tenants may add
    /// their own statuses, always with 'open' behavior (an extra working stage).
    /// </summary>
    public class ShopWorkOrderStatus
    {
        ...
        /// <summary>One of the seven seeded statuses: code and behavior are locked.</summary>
